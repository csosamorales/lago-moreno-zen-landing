...
function TransportCard({ title, children, badge }: TransportCardProps) {
	return (
		<div className="flex flex-col gap-2.5 border-l-2 border-transparent bg-dawn-pink px-6 py-7 transition-colors hover:border-whiskey-dark">
			<p className="font-raleway text-[13px] font-bold uppercase tracking-[1.04px] text-marlin">
				{title}
			</p>
			<div className="font-raleway text-[13px] leading-[24px] opacity-[0.72]">
				{children}
			</div>
			<div className="inline-flex">
				<span className="border border-whiskey-dark px-3 py-1 font-raleway text-[10px] font-semibold uppercase tracking-[1.8px] text-whiskey-dark">
					{badge}
				</span>
			</div>
		</div>
...
export default function ComoLlegar() {
	return (
		<section className="px-8 py-20 md:px-8 lg:px-8">
			<div className="mx-auto max-w-[1100px]">
				{/* Section label */}
				<div className="mb-3 flex items-center gap-3.5">
					<span className="font-raleway text-[10px] font-bold uppercase tracking-[3.5px] text-whiskey-dark">
						Cómo llegar
					</span>
					<div
						className="h-px w-10 bg-whiskey-dark"
						style={{ opacity: 0.4 }}
						aria-hidden="true"
					/>
				</div>
				...
				<div className="flex flex-col gap-12 lg:flex-row lg:gap-12">
					...
					<div className="flex flex-1 flex-col gap-0.5">
						...
						>
							<p className="text-oil">
								...
								. Remises AutoJet tiene mostrador en el sector
								de arribos de planta baja.
							</p>
						</TransportCard>
						...
						>
							<p className="text-oil">
								...
								(disponible en quioscos y en el Centro Cívico).
								Las líneas{' '}
								<span className="font-semibold text-shingle-fawn">
									20, 21 y 22
								</span>{' '}
					...
					<div className="flex flex-1 flex-col gap-4">
						<p className="font-raleway text-[12px] font-medium uppercase tracking-[1.44px] text-whiskey-dark">
						...
						/>
						<p
							className="font-raleway text-[12px] leading-[19.2px] text-oil"
							style={{ opacity: 0.45 }}
						>
							Av. Bustillo km 13, San Carlos de Bariloche · Río
							Negro, Argentina.
							<br />A 200 m de la Playa del Viento, a orillas del
							Lago Moreno.
						</p>
					</div>
				</div>
