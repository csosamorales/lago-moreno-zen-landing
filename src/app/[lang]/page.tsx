...
const apartmentSlugs: Array<{
...
}> = [
	{
		...
		name: 'ZEN I',
		variant: 'horizontal',
		src: '/apartments/zen-i/IMG_3272.webp',
	},
	{
		slug: 'zen-ii',
		name: 'ZEN II',
		variant: 'featured',
		src: '/apartments/zen-ii/IMG_9123.webp',
	},
	{
		slug: 'zen-iii',
		name: 'ZEN III',
		variant: 'normal',
		src: '/apartments/zen-iii/IMG_9145.webp',
	},
	{
		slug: 'mono-zen',
		name: 'MONO ZEN',
		variant: 'horizontal',
		src: '/apartments/mono-zen/5c58bbb9-5a2c-4d6a-95ca-30eb764af50f.webp',
	},
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					<div className="w-full" style={{ aspectRatio: '16/9' }}>
						<iframe
							...
							title="Lago Moreno Zen - Ubicación"
						/>
					</div>
