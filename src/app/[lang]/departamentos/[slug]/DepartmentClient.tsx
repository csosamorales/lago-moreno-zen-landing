			...
			<div className="bg-cream py-16">
				<div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12">
					...
					<div className="lg:col-span-2">
						...
						<SectionLabel>{t.apartmentDetail.amenitiesLabel}</SectionLabel>
					...
					<div className="space-y-6">
						...
						<div className="bg-beige p-6">
							...
							<form className="mt-4 space-y-3" onSubmit={(e) => e.preventDefault()}>
								...
								<input
									type="tel"
									placeholder={t.apartmentDetail.phonePlaceholder}
									className="w-full bg-cream border border-beige-dark px-3 py-2 text-sm text-ink placeholder:text-ink/40 focus:outline-none focus:border-gold"
								/>
								<input
								...
								<textarea
									rows={3}
									placeholder={t.apartmentDetail.messagePlaceholder}
